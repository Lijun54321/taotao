 ...
 * @author lijun
 * @version V1.0
 * @package_name: com.taotao.freemarker
 * @date 19-2-23 下午9:43
 */
public class FreemarkerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		configuration.setDirectoryForTemplateLoading(new File("/home/lijun/taotao/taotao-portal/src/main/webapp/WEB-INF/ftl"));
		...
		Writer out = new FileWriter(new File("/home/lijun/html/hello.html"));
