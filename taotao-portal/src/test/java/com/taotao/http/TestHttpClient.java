...
public class TestHttpClient {
	...
	public void doPost() throws Exception {
		...
		HttpPost httpPost = new HttpPost("http://localhost:8083/rest/testpost.html");
		//创建一个模拟表单
		List<NameValuePair> param = new ArrayList<>();
		param.add(new BasicNameValuePair("name", "张三"));
		param.add(new BasicNameValuePair("password", "123"));
		StringEntity entity = new UrlEncodedFormEntity(param, "utf-8");
		//把表单内容放入httpPost对象
