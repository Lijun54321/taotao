...
<div id="shortcut-2013">
	<div class="w">
		<ul class="fl lh">
            <li class="fore1 ld" clstag="homepage|keycount|home2013|01a"><b></b><a href="javascript:void(0);"
		...
		<ul class="fr lh">
			...
			<li class="fore2 ld" clstag="homepage|keycount|home2013|01c">
				<s></s>
                <a href="javascript:void(0);" rel="nofollow">我的订单</a>
			</li>
			<li class="fore2-1 ld" id="jd-vip">
				<s></s>
                <a target="_blank" rel="nofollow" href="javascript:void(0);">会员俱乐部</a>
			</li>
			<li class="fore3 ld menu" id="app-jd" data-widget="dropdown" clstag="homepage|keycount|home2013|01d">
                ...
                <a href="javascript:void(0);" target="_blank">手机淘淘</a><b></b>
			</li>
			<li class="fore4 ld menu" id="biz-service" data-widget="dropdown" clstag="homepage|keycount|home2013|01e">
				...
				<b></b>
				<div class="dd">
                    <div><a href="javascript:void(0);" target="_blank">帮助中心</a></div>
                    <div><a href="javascript:void(0);" target="_blank" rel="nofollow">售后服务</a></div>
                    <div><a href="javascript:void(0);" target="_blank" rel="nofollow">在线客服</a></div>
                    <div><a href="javascript:void(0);" target="_blank" rel="nofollow">投诉中心</a></div>
                    <div><a href="javascript:void(0);" target="_blank">客服邮箱</a></div>
				</div>
			</li>
			<li class="fore5 ld menu" id="site-nav" data-widget="dropdown" clstag="homepage|keycount|home2013|01f">
				...
				<div class="dd lh">
					<dl class="item fore1">
						<dt>特色栏目</dt>
						<dd>
                            <div><a href="javascript:void(0);">淘淘通信</a></div>
                            <div><a href="javascript:void(0);">校园之星</a></div>
                            <div><a href="javascript:void(0);">为我推荐</a></div>
                            <div><a href="javascript:void(0);">视频购物</a></div>
                            <div><a href="javascript:void(0);">淘淘社区</a></div>
                            <div><a href="javascript:void(0);">在线读书</a></div>
                            <div><a href="javascript:void(0);">装机大师</a></div>
                            <div><a href="javascript:void(0);">淘淘E卡</a></div>
                            <div><a href="javascript:void(0);">家装城</a></div>
                            <div><a href="javascript:void(0);">搭配购</a></div>
                            <div><a href="javascript:void(0);">我喜欢</a></div>
						</dd>
					</dl>
					<dl class="item fore2">
						<dt>企业服务</dt>
