...
<table cellpadding="5" style="margin-left: 30px" id="itemParamAddTable" class="itemParam">
    <tr>
        <td>　　I　d　:</td>
        <td>
            <input name="id" value="${itemParam.id}" readonly="true" style="width: 280px;"/>
        </td>
    </tr>
    <tr>
        <td>商品类目id:</td>
        <td>
            <input name="itemCatId" value="${itemParam.itemCatId}" readonly="true" style="width: 280px;"/>
        </td>
    </tr>
    <tr class="addGroupTr">
        <td>规格参数:</td>
...
<script>
    $(function () {
        var paramData = '${itemParam.paramData}';
        alert("页面加载完成！");
